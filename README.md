...
#### GitHub Pages (free)
1. Create/push this project to a repo named **`budget`** under your GitHub account **`yekrarahman`**.
2. On GitHub: **Settings** → **Pages**.
3. Under **Build and deployment**, choose:
   - **Source**: *Deploy from a branch*
   - **Branch**: `main` (or your default branch), folder `/ (root)`
4. Click **Save** and wait ~1–2 minutes for deployment.
5. Your app URL will be: **`https://yekrarahman.github.io/budget/`**
6. Open that URL on your phone and use browser menu to **Install app / Add to Home Screen**.

##### Quick checklist for this exact link
- GitHub username is exactly: `yekrarahman`
- Repository name is exactly: `budget`
- Repository is pushed and Pages is enabled on the default branch
- Wait for Pages status to show **Your site is live**
